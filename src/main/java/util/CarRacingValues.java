...
public class CarRacingValues {
	public static final String RACERS_EXCEPTION_MSG = "빈 문자열은 입력 불가합니다.";
	public static final String RACING_EXCEPTION_MSG = "최저 1바퀴를 입력해 주세요";
